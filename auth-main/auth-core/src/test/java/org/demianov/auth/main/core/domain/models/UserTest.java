...
public class UserTest {
    ...
    void authenticate_Success() {
        ...
        user.authenticate("rawPassword", this.passwordHasher);
    ...
    void authenticate_PasswordMismatch() {
        ...
        assertThatThrownBy(() -> user.authenticate("rawPassword", this.passwordHasher))
                .isInstanceOf(PasswordMismatchException.class);
    }

    @Test
    @DisplayName("Should throw UserAccountException when user is not active")
    void authenticate_UserAccountLocked() {
        User user = createUser();
        User blockedUser = user.block();

        assertThatThrownBy(() -> blockedUser.authenticate("rawPassword", this.passwordHasher))
    ...
    void rehydrate_Success() {
        ...
        User user = User.rehydrate(this.id, this.email, this.hashedPass, UserStatus.ACTIVE, roles);
